namespace _01.Two_Three
{
    ...
    public class TwoThreeTree<T> where T : IComparable<T>
    {
        ...
        private bool IsLesser(T element, T nodeKey)
        {
            bool isLesser = element.CompareTo(nodeKey) < 0;
